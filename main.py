...
print ""
print "1: New Save"
print "2: Load Previous Save [BETA]"
...
if aa == "new":
    try:
        ...
        filelist = [f for f in os.listdir("C:/Users/Alex/PycharmProjects/colonygame/home/charsheet/") if f.endswith(".py")]
        for f in filelist:
            os.remove(os.path.join("C:/Users/Alex/PycharmProjects/colonygame/home/charsheet/", f))
        print a
        print("Save Deleted")
        time.sleep(1.5)
    except WindowsError:
        open("Savefile.py","w")
print "\n" * 100
print "Importing Savefile..."
time.sleep(1)
from random import randint
if aa == "":
    ImportVars = "Savefile.py"
    exec(ImportVars)
a = "\n" * 100
print a
print "Loading..."
...
if aa == "new":
    ...
    while z == 2:
        ...
        q = ""
        sys.stdout.flush()
        name = open(charname, "r")
        name.close()
        print charname
        src = "C:/Users/Alex/PycharmProjects/colonygame/home/" + charname
        dst = "C:/Users/Alex/PycharmProjects/colonygame/home/charsheet/" + charname
        os.renames(src, dst)
        print a
        print "Loading..."
        print "Please be patient, generating citizens."
print a
execfile('Artfiles.py')
ammo = 0
fear = 0
dealoffer = 0
generator = 0
...
while True:
    ...
    if pop <= 0:
        ...
        if nn == y:
            print "The Great Jacob is pleased."
            Savefile.write('{0} {1}\n'.format("metal=", 1000000))
        break
    if huntingskill < 0:
        huntingskill = 0
    if combatskill < 0:
    ...
    if randomevent == 4:
        ...
        if raidchance == 0:
            ...
            if deathtoll < pop:
                ...
                if gunsteal > 1:
                    gunmark = "s"
                print "You've taken %s gun%s with %s rounds. You've also taken %s people as workers." % (
                gunsteal, gunmark, ammorob, slave)
                pop = pop + slave
    ...
    if choice == "jacob":
        print a
        nn = raw_input("Sacrifice all your people to Jacob? y/n")
        if nn == "y":
            pop = pop - 10000
            metal = metal + 100000000
    if choice == "people":
        print a
        print "Names:"
        ree = os.listdir('C:/Users/Alex/PycharmProjects/colonygame/home/charsheet/')
        ree = str(ree)
        ree = ree.replace(".py", "")
        ree = ree.replace("[", "")
        ree = ree.replace("]", "")
...
""")
        print ree
        print "(m)anage, (h)ealth, or (e)xit"
        while True:  # making a loop
            try:  # used try so that if user pressed other than the given key error will not be shown
        ...
        if m == "health":
            print a
            r = os.listdir('/home/runner/Char_injure/')
            r = str(r)
            r = r.replace(".py", "")
            r = r.replace("[", "")
            r = r.replace("]", "")
...
""")
            print r
        r = raw_input("Type name or press ENTER to resume...")
        if " " in r:
            r = r + ".py"
            r = "C:/Users/Alex/PycharmProjects/colonygame/home/charsheet/" + r
            print a
            execfile(r)
    ...
    if choice == "make":
        ...
        print "Crafting-"
        print """
1. 10x Ammunition: 2 gunpowder, 2 metal							
2. 10x Gunpowder: 5 wood, 20 sulfur									
...
8. Radio Set: 2 metal, 5 wood (generator required)
9. Generator: 5 metal, 5 sulfur														
		"""
            ...
            if camplog > 0:
                ...
                if option == "r":
                    ...
                    if camplog >= 1:
                        ...
                        if deathtoll < sentpeople:
                            ...
                            print a
                            time.sleep(1)
                            print "The %s calls you over a radio. From what you can gather, it's gone well." % (
                                raidname)
                            time.sleep(2)
                            print a
                ...
                if option == "t":
                    ...
                    if random == 2:
                        ...
                        print "The camp would like %s %s. They will give you %s %s" % (
                        randomsell, tradeoffer, randombuy, dealoffer)
                        time.sleep(1)
...
"""
  ...
  __ _-----`  |{,-----------~
       ...
       """
        ...
        if rand == 5:
            ...
            if dam == 1:
                ...
                delpath = (random.choice(glob.glob("/home/runner/charsheet/*.py")))
                src = delpath
                delpath2 = delpath.replace("/home/runner/charsheet/", "")
                dst = "/home/runner/Char_injure/r.py"
                os.renames(src, dst)
                pop = pop - 1
                m = open(dst, "a", 0)
                m.write('{0} {1}\n'.format("print", "'Has a broken arm.'"))
                src = dst
                dst = "/home/runner/Char_injure/" + delpath2
                os.renames(src, dst)
                delpath2 = delpath2.replace(".py", "")
                print "%s's arm was broken by a raider." % delpath2
    ...
    if choice == "help":
        ...
        print "q: Exits the game. Don't worry, it saves [BETA- DOES NOT SAVE CURRENTLY]."
        print ""
        print "h: This can be used to hunt animals. Using ammo will increase the amount of meat, but you can hunt without weapons for a lesser amount."
        print "s: Use this command to scout the area for other survivors, resources, or camps"
        print "r: Used to raid scouted out camps. Be aware of your resources however."
        print "m: This opens up the crafting menu."
        print "z: This opens up quarries, camp, and defense manager."
        print "v: Use this to check how many resources you have."
        print "a: Used to check for survivors."
        print "p: Opens the people manager."
